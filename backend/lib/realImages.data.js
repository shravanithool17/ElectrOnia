// lib/realImages.data.js — High-resolution studio photography for ElectrOnia products.
//
// These replace the generic SVG blueprint illustrations with authentic,
// studio-lit photographs across all categories and shapes.

export const REAL_IMAGES_BY_SHAPE = {
  // Laptops
  'laptop': [
  ...
  'laptop-gaming': [
    ...
    'https://images.unsplash.com/photo-1542393545-10f5cde2c810?auto=format&fit=crop&w=1000&q=80',
...
export const REAL_IMAGES_BY_TITLE = {
  // Apple Laptops
